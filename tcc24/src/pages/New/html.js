...
const videos = [
  {
    id: 1,
    title: 'Aprenda HTML em 10 minutos',
  ...
  {
    id: 2,
    title: 'HTML para iniciantes: Tutorial completo',
    thumbnail: 'https://via.placeholder.com/150',
  ...
  {
    id: 3,
    title: 'Dicas avançadas de HTML e CSS',
    thumbnail: 'https://via.placeholder.com/150',
  ...
  {
    id: 4,
    title: 'Como criar formulários em HTML',
    thumbnail: 'https://via.placeholder.com/150',
    channel: 'Nome do Canal 3',
    views: '250K visualizações',
    uploadDate: 'Há 3 semanas', 
  ...
  {
    id: 5,
    title: 'HTML5: Novas funcionalidades e tags',
    thumbnail: 'https://via.placeholder.com/150',
    channel: 'Nome do Canal 3',
    views: '250K visualizações',
    uploadDate: 'Há 3 semanas', 
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerText}>Aulas de HTML</Text>
      </View>
      <ScrollView>
